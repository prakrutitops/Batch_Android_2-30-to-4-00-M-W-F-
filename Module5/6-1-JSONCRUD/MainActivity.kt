...
class MainActivity : AppCompatActivity()
{
    ...
    override fun onCreate(savedInstanceState: Bundle?)
    {
        ...
        binding.btn1.setOnClickListener {
            ...
            var stringRequest:StringRequest = object:StringRequest(Request.Method.POST,MyAPI.INSERT,Response.Listener {
                ...
                Toast.makeText(applicationContext,"Product Insertion Failed",Toast.LENGTH_LONG).show()
