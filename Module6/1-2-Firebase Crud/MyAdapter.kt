...
class MyAdapter(options: FirebaseRecyclerOptions<Model>) : FirebaseRecyclerAdapter<Model, myviewholder>(options)
{
    ...
    override fun onBindViewHolder(holder: myviewholder, position: Int, model: Model) {
            ...
            holder.edit.setOnClickListener {
                ...
                val name = myview.findViewById<EditText>(R.id.edt1)
                val pass = myview.findViewById<EditText>(R.id.edt2)
                val email = myview.findViewById<EditText>(R.id.edt3)
                val submit = myview.findViewById<Button>(R.id.btninsert)
                ...
                submit.setOnClickListener {
                    ...
                    FirebaseDatabase.getInstance().getReference().child("lenovo")
